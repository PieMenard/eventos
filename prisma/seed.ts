...
const events = [
    {
        ...
        imageUrl:
            "https://images.unsplash.com/photo-1519683109079-d5f539e1542f?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        description:
    ...
    },
    {
        ...
        imageUrl:
            "https://images.unsplash.com/photo-1465847899084-d164df4dedc6?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        description:
...
async function main() {
    ...
    for (const event of events) {
        const result = await prisma.eventosEvent.upsert({
            where: { id: event.id },
            update: {},
            create: event,
        });
